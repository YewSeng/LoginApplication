function validateForm() {
    ...
    var usernameRegex = /^[MU][a-zA-Z0-9]{7,}$/; // Username must start with 'M' or 'U' followed by at least 7 characters and numbers
    ...
    if (!usernameRegex.test(username)) {
        usernameError = "Username must start with an uppercase 'M' or 'U' followed by at least 7 characters";
    ...
    if (errorMessage.trim() !== "") {
        errorDiv.innerText = "Invalid userid or password";
