function validateForm() {
    ...
    var usernameRegex = /^M[a-zA-Z0-9]{7,}$/; // Username must start with 'M' followed by at least 7 characters and numbers
    ...
    if (!usernameRegex.test(username)) {
        usernameError = "Username must start with an uppercase 'M' followed by at least 7 characters";
