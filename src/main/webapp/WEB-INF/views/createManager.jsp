...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/createManager.css">
	<script src="${pageContext.request.contextPath}/js/managerFormValidation.js"></script>
</head>
<body>
    ...
    <div class="center-container">
        ...
        <form action="<c:url value='/api/v1/superadmins/registerManager'/>" method="POST" onsubmit="return validateForm()">
